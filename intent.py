...
from utils import segment_with_textsplit
import torch
...
def main(model_name="paraphrase-multilingual-mpnet-base-v2"):
    ...
    # templates = load_templates("intent_templates.json")
    ...
    for paragraph in paragraphs:
        ...
        blocks, _ = segment_with_textsplit(sentences, embeddings, window_size=window_size, debug=True)
